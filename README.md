...
## Current Project Status <i
                        class="fas fa-long-arrow-alt-right arrow1" aria-hidden="False"></i> ![Status](https://github.com/Atharv-Chaudhari/Sem-7-Covid/actions/workflows/django.yml/badge.svg)
